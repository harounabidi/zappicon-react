...
const SvgQuestionCircleDuotoneLine = (props: SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <g fill="currentColor" clipPath="url(#question-circle-duotone-line_svg__a)">
      <path
    ...
    <defs>
      <clipPath id="question-circle-duotone-line_svg__a">
        <path fill="#fff" d="M0 0h24v24H0z" />
      </clipPath>
    </defs>
  </svg>
);
export default SvgQuestionCircleDuotoneLine;
