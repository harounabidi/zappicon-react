...
const SvgArrowUpCircleLight = (props: SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <g fill="currentColor" clipPath="url(#arrow-up-circle-light_svg__a)">
    ...
    <defs>
      <clipPath id="arrow-up-circle-light_svg__a">
        <path fill="#fff" d="M0 0h24v24H0z" />
      </clipPath>
    </defs>
  </svg>
);
export default SvgArrowUpCircleLight;
