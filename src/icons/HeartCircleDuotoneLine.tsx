...
const SvgHeartCircleDuotoneLine = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    <g
      fill="currentColor"
      fillRule="evenodd"
      clipPath="url(#heart-circle-duotone-line_svg__a)"
      clipRule="evenodd"
    >
      <path
    ...
    <defs>
      <clipPath id="heart-circle-duotone-line_svg__a">
        <path fill="#fff" d="M0 0h24v24H0z" />
      </clipPath>
    </defs>
  </svg>
);
export default SvgHeartCircleDuotoneLine;
