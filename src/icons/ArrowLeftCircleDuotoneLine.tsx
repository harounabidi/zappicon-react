...
const SvgArrowLeftCircleDuotoneLine = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    <g
      fill="currentColor"
      clipPath="url(#arrow-left-circle-duotone-line_svg__a)"
    >
      <path
    ...
    <defs>
      <clipPath id="arrow-left-circle-duotone-line_svg__a">
        <path fill="#fff" d="M0 0h24v24H0z" />
      </clipPath>
    </defs>
  </svg>
);
export default SvgArrowLeftCircleDuotoneLine;
