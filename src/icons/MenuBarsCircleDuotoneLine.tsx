...
const SvgMenuBarsCircleDuotoneLine = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    <g
      fill="currentColor"
      clipPath="url(#menu-bars-circle-duotone-line_svg__a)"
    >
      <path
    ...
    <defs>
      <clipPath id="menu-bars-circle-duotone-line_svg__a">
        <path fill="#fff" d="M0 0h24v24H0z" />
      </clipPath>
    </defs>
  </svg>
);
export default SvgMenuBarsCircleDuotoneLine;
