...
const SvgArrowDownLeftCircle = (props: SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <g fill="currentColor" clipPath="url(#arrow-down-left-circle_svg__a)">
      <path
        d="M12 .25C5.51.25.25 5.51.25 12S5.51 23.75 12 23.75 23.75 18.49 23.75 12 18.49.25 12 .25"
        opacity={0.4}
      />
      <path d="M8.5 16.25a.75.75 0 0 1-.75-.75V10a.75.75 0 0 1 1.5 0v3.69l5.72-5.72a.75.75 0 1 1 1.06 1.06l-5.72 5.72H14a.75.75 0 0 1 0 1.5z" />
    </g>
    <defs>
