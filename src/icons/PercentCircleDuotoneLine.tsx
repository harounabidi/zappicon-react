...
const SvgPercentCircleDuotoneLine = (props: SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <g fill="currentColor" clipPath="url(#percent-circle-duotone-line_svg__a)">
      <path
    ...
    <defs>
      <clipPath id="percent-circle-duotone-line_svg__a">
        <path fill="#fff" d="M0 0h24v24H0z" />
      </clipPath>
    </defs>
  </svg>
);
export default SvgPercentCircleDuotoneLine;
