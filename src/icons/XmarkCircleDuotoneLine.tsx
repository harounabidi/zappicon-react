...
const SvgXmarkCircleDuotoneLine = (props: SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <g fill="currentColor" clipPath="url(#xmark-circle-duotone-line_svg__a)">
      <path
    ...
    <defs>
      <clipPath id="xmark-circle-duotone-line_svg__a">
        <path fill="#fff" d="M0 0h24v24H0z" />
      </clipPath>
    </defs>
  </svg>
);
export default SvgXmarkCircleDuotoneLine;
